        ...
        <div class="row">
            <div class="col-md-12">
                <div class="wrapper">
                       ...
                       echo form_open_multipart("newadmin/uuploadassignments/$iid", $attributes);
                      ?>
...
a=a+1;
b=b+1;
var txtbox = '<div><input class="form-control ass_input" type="text" name="newll[]" id="newo'+a+'" placeholder="Adding Question.." value="" style="margin-bottom: 15px;width:94% !important;display:inline-block;"><button type="button" id="'+a+'" onClick="removeRow(id)" style="">remove</button></div>';
