...
<head>
	...
	<!--<script type="text/javascript"<?php echo base_url('assets/js/chat1.js');?>"></script>-->
	<!--<script type="text/javascript"<?php echo base_url('assets/js/chat2.js');?>"></script>-->
        <!--<script type="text/javascript"<?php echo base_url('assets/js/chat3.js');?>"></script>-->
	<script type="text/javascript">	  
		$( document ).ready ( function () {
			...
			// initial nickname check
                        //till now no requirement of below line
			$('#nickname').trigger('keyup');

                         $('#submit').click(function (e) {
                                   // alert('submit click function is called!!');
	                          e.preventDefault();
              ...
              $('#message').keyup(function (e) {
	             if (e.which == 13) {
                               //alert('message from the keyup is called!!!');
		             $('#submit').trigger('click');
	                   }
                         });

           setInterval(function (){
                    //alert('set interval is called before update chate!!');
	         update_chats();
                   //alert('set interval after update chate!!');
             },5000);
...
var update_chats = function () {
                     // alert('this is Inside Update chates!!!!');
	if(typeof(request_timestamp) == 'undefined' || request_timestamp == 0){
                     // alert('this is Inside Update fucntion INSIDE IF!!!!');
