...
<link rel="stylesheet" href="http://arfeenkhan.com/questionnaire1/css/fontmain.css">
  <link rel="stylesheet" href="http://arfeenkhan.com/questionnaire1/css/main.css">
  <link rel="stylesheet" href="http://arfeenkhan.com/questionnaire1/css/responsive.css">
...
<div class="main">	
		...
		<input type="text" name="firstname" id="firstname" placeholder="Name" value="anand" />
						
		<input type="email" name="email" id="email" placeholder="Email" value="sharmaanand@gmail.com" />
						
		<br/>
						
		<!--<div id="showMobile" >-->
			
		<input type="tel" name="mobile" id="mobile" placeholder="Contact No" value="9874563210" />
