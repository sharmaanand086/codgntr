			...
			$(document).ready(function()
			{
				...
				$(".pages").each(function(index)
				{
				    ...
				    $(".showpage"+count_div).click(function()
				    {
						...
						{
							$(".page"+count_div).show();
							$(".page"+count_div).css('padding-top','110px');
							$(".info").css('padding-top','110px');
...
<div id="back">
  ...
  <a href="<?php echo base_url(); ?>"><span>Go to arfeenkhan.com</span></a>
...
<div class="pages">	
	...
	<ul style="list-style-type: decimal;" >
		...
		?>
	<li>
	<input onchange="getTotalCheckRad();" type="radio"  name="abc<?php echo ($j+1); ?>" value="<?php echo $this->encrypt->encode(intval($optvalue->value)); ?>" ><?php echo $optvalue->text; ?> 
	...
	<ul>
		<li><input onchange="getTotalCheckRad();" class="radio1" type="radio" name="abc<?php echo ($j+1); ?>" value="<?php echo $this->encrypt->encode(10); ?>" ><label for="radio1"><span><span></span></span></label> Yes </li>
		<li><input onchange="getTotalCheckRad();" class="radio2" type="radio" name="abc<?php echo ($j+1); ?>" value="<?php echo $this->encrypt->encode(0); ?>" ><label for="radio2"><span><span></span></span></label> No </li>
		<li><input onchange="getTotalCheckRad();" class="radio3" type="radio" name="abc<?php echo ($j+1); ?>" value="<?php echo $this->encrypt->encode(5); ?>"  ><label for="radio3"><span><span></span></span></label> Partly </li>
	</ul>
	<?php } 
...
<div class="clear"> </div> 
	...
	++$next_page_question;
		...
		if($i != 1)
			{ ?> 
				<?php /*
				<p class="showpage<?php echo ($i-1); ?>" > Previous Page </p> 
				*/ ?>
		...
		if( isset($questions[$count_question]) )
			...
			?>	
				<?php /*
				<p class="showpage<?php echo ($i+1); ?>" href="pagetop<?php echo ($i+1); ?>" > Next Page </p>
				*/ ?>
...
?>
 ...
 <script>
	...
	function Tick() {
		alert('Five Minutes Remaining.');
		//$('#warnUser').show();
	}
	
	//$("#ms_timer").countdown('resume');
