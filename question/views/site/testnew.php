...
<div class="header">
        <div class="navbar">
            ...
            <div class="back">GO BACK TO ARFEEN<span>KHAN</span>.COM</div>
        </div>
    ...
    <input type="text" placeholder="Enter your name" class="form-control" name="firstname" id="firstname">
    <input type="email" placeholder="Enter your email" class="form-control" name="email" id="email">
    <input type="text" placeholder="Enter your contact number" class="form-control" name="mobile" id="mobile">
...
<div class="cont_body">
<div class="cont_1">
    <div class="left"><img src="images/step1.png" /></div>
    <div class="right">
...
<div class="cont_2">
<div class="left"><img src="images/step2.png" /></div>
    <div class="right">
...
<div class="cont_3">
<div class="left"><img src="images/step3.png" /></div>
    <div class="right">
...
<div class="main">	
		...
		<h5 style="display:none;">STEPS</h5>

<div id="allsteps" style="display:none;">
...
<div class="clear"> </div>
 ...
 $( document ).ready(function(){
	...
	<div id="" >	
	 ...
	 <!--             </tr>-->
	 <!--             <tr>-->
	 <!--             <td colspan="4"><span id="demo"></span></td>-->
	 <!--             </tr>-->
	 <!--        </table>-->
	 <!--        </div>-->
  </div>       			
...
<div class="pages">	
	...
	<ul class="chu" style="list-style-type: none;" >
	...
	<ul class="hello">
				<input onchange="getTotalCheckRad();" type="radio" id="abc<?php echo ($j+1); ?>g" name="abc<?php echo ($j+1); ?>" class="green" value="yes" >
            <label for="abc<?php echo ($j+1); ?>g" class=""></label>

            <input onchange="getTotalCheckRad();" type="radio" id="abc<?php echo ($j+1); ?>r" name="abc<?php echo ($j+1); ?>" class="red" value="no" >
            <label for="abc<?php echo ($j+1); ?>r" class=""></label>

            <input onchange="getTotalCheckRad();" type="radio" id="abc<?php echo ($j+1); ?>b" name="abc<?php echo ($j+1); ?>" class="blue" value="partly" >
	...
	++$next_page_question;
		...
		if($i != 1)
			{ ?> 
				...
				*/ ?><div class="imp_button" style="display:inline-block">
				<div class="next_page "><a class="showpage<?php echo ($i-1); ?>" href="#ShowQuestion" > Previous Page </a> </div>
		...
		if( isset($questions[$count_question]) )
			...
			?>	
				...
				*/ ?>
				<div class="next_page ">
				<a class="showpage<?php echo ($i+1); ?> " href="#ShowQuestion"  > Next Page </a></div>
				</div>
			<?php 
			...
			{
				?>
				<div class=""> <input type="submit" id="submitButton" class="showpage<?php echo $i; ?>" name="submit" value="SUBMIT" ></div>
...
?>
 ...
 <script>
                                    ...
                                    $('#demo').countdowntimer({
                                        ...
                                        size : "lg",
                                      	timeUp : timeisUp ,
                                        expiryUrl : "<?php echo base_url(); ?>thankYouPage"
