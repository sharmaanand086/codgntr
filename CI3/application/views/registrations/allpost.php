...
<header class="masthead" style="background-image: url(<?php echo base_url('assets/theme/img/bg-index.jpg'); ?>)">
 ...
 <div class="container">
   <?php if(!empty($blogs)): ?>
      <?php   foreach ($blogs->result() as $myblogs): ?> 
    <div class="row">
      <div class="col-lg-8 col-md-10 mx-auto"> 
         <article class="post-preview">       
          <a href="<?php echo site_url('Blog/readblog/'.$myblogs->bid); ?>">
            <h2 class="post-title"><?php echo $myblogs->btitle; ?></h2>        
            <h3 class="post-subtitle"><?php echo $myblogs->bbody; ?></h3>            
          </a>
          <p class="post-meta">Posted by <?php echo $myblogs->fullName; ?> on <?php echo date('D M Y ',strtotime($myblogs->bdate));  ?> &middot;
